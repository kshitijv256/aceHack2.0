...
const Item = (props) => {
  return (
    <div className="flex flex-col items-center bg-cyan-600/40 rounded-md hover:shadow-lg hover:shadow-cyan-500 my-10 p-4 mx-5 h-60 w-60 md:shadow-none shadow-blue-600">
