...
const Item = (props) => {
  return (
    <div className="flex flex-col items-center bg-blue-500/50 rounded-md hover:shadow-lg hover:shadow-blue-600 my-10 p-4 h-60 w-60 md:shadow-none shadow-blue-600">
